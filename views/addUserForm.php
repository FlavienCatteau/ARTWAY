...
<div class="row flex-column align-items-center">
    <form name="form" action="" method="POST" class="col-11 col-md-6 form-group p-4 mb-4">
        ...
        <div class="m-3 p-0 d-flex justify-content-around">
            <a href="?page=accueil" class="btn btn-outline-danger text-white">Retour</a>
            <input type="submit" id='submitRegister' name='registerForm' class="btn btn-outline-success text-white font-weight-bold mr-0" value="Envoyer">              
        </div> 
    </form>
</div>
